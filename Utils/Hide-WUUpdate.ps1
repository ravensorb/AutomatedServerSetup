Function Hide-WUUpdate
{
	...
	.EXAMPLE
		...
		------------ ------ --          ---- -----
		KOMPUTER     ---H-- KB976002  102 KB Aktualizacja firmy Microsoft z ekranem wybierania przegl¹darki dla u¿ytkowników...
		KOMPUTER     ---H-- KB971033    1 MB Aktualizacja dla systemu Windows 7 dla systemów opartych na procesorach x64 (KB...
		KOMPUTER     ---H-- KB2533552   9 MB Aktualizacja systemu Windows 7 dla komputerów z procesorami x64 (KB2533552)
